...
public:
    ...
    void SetPlayerMaxHp(int nMaxHp) { m_nPlayerMaxHp = nMaxHp; }
    void SetPlayerCurHp(int nCurHp) { m_nPlayerCurHp = nCurHp; }
    void SetPlayerHp(int nMaxHp, int nCurHp) { m_nPlayerMaxHp = nMaxHp; m_nPlayerCurHp = nCurHp; }
...
public:
    ...
    int                             m_nPlayerMaxHp = 0;
    int                             m_nPlayerCurHp = 0;

    XMFLOAT2                        m_xmf2EnemyPos[MAX_ENEMY_COUNT] = {XMFLOAT2(NULL_POS, NULL_POS),
                                                                        XMFLOAT2(NULL_POS, NULL_POS), 
                                                                        XMFLOAT2(NULL_POS, NULL_POS), 
                                                                        XMFLOAT2(NULL_POS, NULL_POS), 
                                                                        XMFLOAT2(NULL_POS, NULL_POS), 
                                                                        XMFLOAT2(NULL_POS, NULL_POS), 
