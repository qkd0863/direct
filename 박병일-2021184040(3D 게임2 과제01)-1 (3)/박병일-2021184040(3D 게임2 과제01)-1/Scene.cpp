...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, 25 + 50 + 1 + 1 + 3); //SuperCobra(17), Gunship(2), Player(1), Skybox(1), Terrain(3)
	...
	m_pTerrainWater->SetPosition(+(257 * xmf3Scale.x * 0.5f), 555.0f, +(257 * xmf3Scale.z * 0.5f));
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[9].BaseShaderRegister = 17; //t17~19: gtxtTerrainwaterTexture
	...
	pd3dDescriptorRanges[11].BaseShaderRegister = 20; //t20: gtxtTextureCube
